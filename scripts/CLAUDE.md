...
| `lib/messages.mjs` | Single source of every lint message, imported by lint and harness — rewording cannot drift assertions (LRN-14). | [dcx-docs-check.yaml](../docs/specs/dcx-docs-check.yaml) |
