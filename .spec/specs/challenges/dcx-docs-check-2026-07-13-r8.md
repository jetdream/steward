...
- **r7 low #1 fix**: `record: .spec/specs/challenges/../../product/vision.md` now fires the DCX-13 outside-dir error on the resolved path; an inside-dir `../challenges/` traversal correctly resolves clean.
