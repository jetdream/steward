...
5. **Approval Inbox + manual composer.** The one-tap digest remains the core; additionally the founder can always compose a post manually — write it, attach a picture, pick channels — and the system handles adaptation, scheduling, and publishing.
