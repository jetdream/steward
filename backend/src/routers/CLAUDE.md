...
**Requirements this folder realizes** (14 — aggregated per register; detail: `cortex graph pack <ID>`):
...
**Spec-elements:** ACCS-1, ONBS-1, MEMS-1, STRS-1, ONBS-2, ACCS-2, STRS-2, ONBS-3, ACCS-3, MEMS-4, MEMS-5, ONBS-5, ONBS-6
