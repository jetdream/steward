...
**Requirements this folder realizes** (19 — aggregated per register; detail: `cortex graph pack <ID>`):
...
**Spec-elements:** ACCS-1, ONBS-1, INTS-1, MEMS-1, EXTS-1, STRS-1, INTS-2, ONBS-2, ACCS-2, STRS-2, ONBS-3, ACCS-3, INTS-4, MEMS-4, MEMS-5, ONBS-5, EXTS-5, ONBS-6
