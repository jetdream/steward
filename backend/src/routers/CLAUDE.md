...
**Requirements this folder realizes** (24 — aggregated per register; detail: `cortex graph pack <ID>`):
...
- Planning & Content Generation — 2 requirement(s) realized here: GEN-2…GEN-5 (.spec/product/requirements/gen-content-generation.yaml)
...
**Spec-elements:** ACCS-1, ONBS-1, CHTS-1, INTS-1, MEMS-1, EXTS-1, STRS-1, CHTS-2, GENS-2, INTS-2, ONBS-2, ACCS-2, STRS-2, ONBS-3, ACCS-3, CHTS-4, INTS-4, MEMS-4, GENS-5, MEMS-5, ONBS-5, EXTS-5, ONBS-6
